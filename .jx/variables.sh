...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x/terraform-google-jx/master/4'
...
export MINK_IMAGE='ghcr.io/jenkins-x/terraform-google-jx:1.10.5'
