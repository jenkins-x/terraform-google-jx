...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/terraform-google-jx/master/4'
...
export MINK_IMAGE='ghcr.io/jenkins-x/terraform-google-jx:1.10.11'
